...
const CategoryScreen = ({ navigation }) => {
  const [skills, setSkills] = useState([
    {
      id: 1,
      image: require("../../assets/skill/EstatesCard.png"),
      name: "Shipping",
      checked: false,
    },
    {
      id: 2,
      image: require("../../assets/skill/Vertical-Full.png"),
      name: "Cleaner",
      checked: false,
    },
    {
      id: 3,
      image: require("../../assets/skill/Vertical-Full1.png"),
      name: "Picker",
      checked: false,
    },
    {
      id: 4,
      image: require("../../assets/skill/Vertical-Full3.png"),
      name: "Forklift Operator",
      checked: false,
    },
    {
      id: 5,
      image: require("../../assets/skill/Sorter.png"),
      name: "Sorter",
      checked: false,
    },
    {
      id: 6,
      image: require("../../assets/skill/AssembleWorkerLine.png"),
      name: "Assemble Line Worker",
      checked: false,
    },
    {
      id: 7,
      image: require("../../assets/skill/Group 1.png"),
      name: "Picker",
      checked: false,
    },
    {
      id: 8,
      image: require("../../assets/forklift.png"),
      name: "Forklift Operator",
      checked: false,
    },
  ]);
